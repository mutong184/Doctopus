...
fin_list = ['Company_Name: The name of the company, add “Inc.” or “Company” as a suffix. or leave empty if not applicable',
               'Founding_Year: The year the company was founded (e.g., “2003”). or leave empty if not applicable', 
               'Headquarters_Location: The headquarters address, as it is written in the original text.or leave empty if not applicable', 
               'Industry_Type: The industry category of the company (Categories include:Energy andResources; Industrial and Manufacturing; Real Estate and Construction; Retaiand Consumer;)Multiple categories can be selected.or leave empty if not applicable', 
               'Product_Service_Type: The company’s products, which can be inferred from the opening of each paragraph.or leave empty if not applicable', 
               'Customer_Type: The type of customers the company serves.or leave empty if not applicable',
               'Tax_Policy: Whether the company has a special tax policy. If yes, fill 1; if no, fill 0.', 
               'Branches_Office: Whether the company has branch offices. If yes, fill 1; if no, fill 0.',
               'Brand_Number: The number of brands the company has, in numerical form.if no, fill 0.', 
               'Changed_Name: Whether the company has changed its name. If yes, fill 1; if no, fill 0.', 
               'Segments_Number: The number of departments or divisions the company has, in numerical form.if no, fill 0.']
...
info_dataset= {
        ...
        "nba":{
            ...
            "validation_dir":"C:\\Users\\jjli74\\Desktop\\nba\\nba_sample",
